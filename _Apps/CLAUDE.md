...
> 2026 年新仕様により Android から楽天 API への直接アクセスは不可。**すべて中継サーバー（NewReleaseChecker.Relay, `https://kaz.server-on.net:49443`）経由**で利用する（`Android引き継ぎメモ.md` / `中継サーバー_要件定義書.md` 参照）。
