...
namespace Netkeiba.Models
{
	public partial class OptimizedHorseFeatures
	{
		...
		[Features(Type = FeaturesType.All | FeaturesType.Connection | FeaturesType.JockeyOther)]
		...
		[Features(Type = FeaturesType.AllOther | FeaturesType.Connection | FeaturesType.JockeyOther)]
		...
		[Features(Type = FeaturesType.AllOther | FeaturesType.ConnectionOther | FeaturesType.JockeyOther, Normalization = true)]
		public float JockeyAvgTime2Top { get; set; }

		[Features(Type = FeaturesType.AllOther | FeaturesType.ConnectionOther | FeaturesType.JockeyOther)]
		...
		[Features(Type = FeaturesType.AllOther | FeaturesType.Connection | FeaturesType.JockeyOther, Normalization = true)]
		...
		[Features(Type = FeaturesType.AllOther | FeaturesType.ConnectionOther | FeaturesType.Jockey)]
	...
	public partial class OptimizedHorseFeatures
	{
		...
		public static CustomProperty[] GetProperties(Type type)
		{
